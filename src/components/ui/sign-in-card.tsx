            ...
            <div className="relative bg-neutral-950/80 backdrop-blur-xl rounded-2xl p-7 border border-white/[0.08] shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="appearance-none h-4 w-4 rounded border border-white/20 bg-white/[0.05] checked:bg-white checked:border-white focus:outline-none transition-all duration-200"
                    />
                    {rememberMe && (
                      <motion.div 
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 1, scale: 1 }}
                        className="absolute ml-[1px] flex items-center justify-center text-black pointer-events-none"
                      >
                ...
                <p className="text-center text-xs text-white/50 mt-5">
                  ...
                  <Link to="/signup" className="text-white hover:text-white/70 font-medium transition-colors underline underline-offset-4 decoration-white/30 hover:decoration-white/60">
                    Sign up
                  </Link>
                </p>
              </form>
